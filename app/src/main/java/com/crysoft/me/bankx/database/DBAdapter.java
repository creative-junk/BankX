...
public class DBAdapter extends SQLiteOpenHelper {
    ...
    private static final String KEY_INSURANCE_STATUS = "bank_status";
    ...
    private static final String KEY_MICRO_FINANCE_STATUS = "bank_status";
    ...
    private static final String KEY_FOREX_BUREAU_STATUS = "bank_status";
    ...
    private static final String KEY_INVESTMENT_BANK_STATUS = "bank_status";
    ...
    private static final String KEY_COMPANY_STATUS = "bank_status";
    ...
    private static final String KEY_INTERNATIONAL_BANK_STATUS = "bank_status";
    ...
    public List<BankModel> getBanks() {
        ...
        Cursor cursor = db.query(TABLE_BANKS, new String[]{
                KEY_BANK_ID, KEY_BANK_OBJECT_ID, KEY_BANK_NAME, KEY_BANK_IMAGE, KEY_BANK_ADDRESS, KEY_BANK_STATUS
    ...
    public List<InsuranceModel> getInsuranceAgencies() {
        ...
        Cursor cursor = db.query(TABLE_INSURANCE, new String[]{
                KEY_INSURANCE_ID, KEY_INSURANCE_OBJECT_ID, KEY_INSURANCE_NAME, KEY_INSURANCE_IMAGE, KEY_INSURANCE_ADDRESS, KEY_INSURANCE_STATUS
        }, null, null, null, null, null);
        try {
            if (cursor.moveToFirst()) {
                do {
    ...
    public List<MicroFinanceModel> getMicroFinance() {
        ...
        SQLiteDatabase db = getReadableDatabase();
        Cursor cursor = db.query(TABLE_BANKS, new String[]{
                KEY_MICRO_FINANCE_ID, KEY_MICRO_FINANCE_OBJECT_ID, KEY_MICRO_FINANCE_NAME, KEY_MICRO_FINANCE_IMAGE, KEY_MICRO_FINANCE_ADDRESS, KEY_MICRO_FINANCE_STATUS
        }, null, null, null, null, null);
        try {
            if (cursor.moveToFirst()) {
                do {
    ...
    public List<ForexBureauModel> getForexBureau() {
        ...
        Cursor cursor = db.query(TABLE_FOREX_BUREAUS, new String[]{
                KEY_FOREX_BUREAU_ID, KEY_FOREX_BUREAU_OBJECT_ID, KEY_FOREX_BUREAU_NAME, KEY_FOREX_BUREAU_IMAGE, KEY_FOREX_BUREAU_ADDRESS, KEY_FOREX_BUREAU_STATUS
        }, null, null, null, null, null);
        try {
            if (cursor.moveToFirst()) {
                do {
